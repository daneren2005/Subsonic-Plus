...
import net.sourceforge.subsonic.androidapp.billing.util.Base64;
import net.sourceforge.subsonic.androidapp.billing.util.Base64DecoderException;
...
public class Security {
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAi2Lg7Khu2FRV1xiB+a89nOt/u8FYfujXK8XetmxPS8ZW3x0mP" +
                    "Yvsn0oQUQ/WMOi79Nl6tHVr7n9jbcDrJBReNKeLsQH2vXNowL86+X3LtHezmlMw4RN97Xi2m1xNrWgOcnVT3fPyIKra4GJ0Nic4c/Bt8ieSctNTCARIyR" +
                    "P3F28D2r2mGNgtESlnTZRbW34LSXi+mKptxep4s1FDmYEp3e8IrGYUfiufkOU0/gNc03S+1GYW++ikL6XuAQ41QdBXuFQlC22UTGIvFHCG1QJHyIdPOq5" +
                    "0z6GhJVaAG9OWE2rOOBMAOhowHU9Ywd7KoovIfxFRFI8Lu8qkuVXMlL4qqQIDAQAB";
