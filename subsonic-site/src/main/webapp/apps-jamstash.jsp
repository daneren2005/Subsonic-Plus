    ...
    <div class="content">
        <div class="wide-content">
            ...
            <ul class="list">
                ...
                <li>Customizable (features can be turned on/off and settings are saved)</li>
                <li>Keyboard shortcuts (back, forward, play/pause, skip to artist)</li>
                <li>Playlists (create new, add to existing, delete, drag and drop sorting)</li>
                <li>Artist/Album ratings</li>
                <li>Chat and Now playing</li>
                <li>Last.fm</li>
            </ul>
